...
# Anypoint Template: SiebeltoSalesfroce-Contact-Migration
...
Simple steps to get SiebeltoSalesfroce-Contact-Migration running
...
Once your app is all set and started, supposing you choose as domain name `SiebeltoSalesfroce-Contact-Migration` to trigger the use case you just need to hit `http://SiebeltoSalesfroce-Contact-Migration.cloudhub.io/synccontacts` and report will be sent to the emails configured.
